...
%% Secciones
% --- Parte divulgativa ---
\include{Secciones/00Motivacion}
\include{Secciones/02Imagen}
\include{Secciones/04Redes}
...
\begin{center}
    ...
    \begin{tabular}{ccc}
        ...
        &\phantom{.\hspace{.5cm}.}&
        \color{azul!60!black}\qrcode[hyperlink,height=2.5cm]{https://github.com/andres-merino/Presentacion-AnalisisImagenesFCENA}
        \\[1.3cm]
