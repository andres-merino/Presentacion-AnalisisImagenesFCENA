...
\begin{frame}
    ...
    \begin{block}{Objetivo}
        Entrenar una red neuronal para \textbf{detectar y clasificar polinizadores}
        en imágenes de flores, y usar esas detecciones para reconstruir
        automáticamente redes de interacción \textbf{planta-polinizador}.
    \end{block}

    \pause
    \begin{itemize}
        \item \textbf{Datos:} 5\,445 imágenes con polinizadores identificados manualmente.
        \item \textbf{Modelo:} YOLOv5 con transferencia del aprendizaje.
        \item \textbf{Meta:} reproducir la red ecológica real con la mayor fidelidad posible.
    \end{itemize}
...
\vspace*{-3mm}
    \begin{center}
        \postitimg[0.63\textwidth]{Figuras/ejemplos.png}
    \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \begin{center}
        \postitimg[0.7\textwidth]{Figuras/distribucion_especies_aumento.png}
    \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \vspace*{-1mm}
    \begin{itemize}
        \item Entrenamiento: 100 épocas, lote de 32 imág., ancho de 1280 px.
...
\begin{frame}
    ...
    \column{.6\textwidth}
        \begin{center}
        \postitimg[0.96\textwidth]{Figuras/matriz_confusion_yolov5.png}
        \end{center}
    \end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \vspace*{-1cm}
    \begin{center}
        \postitimg[0.95\textwidth]{Figuras/test_yolov5m_v01_area.png}
    \end{center}
    \end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \begin{center}
        \postitimg[0.82\textwidth]{Figuras/matriz_interacciones_real.png}
    \end{center}
\end{frame}    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \begin{center}
        \postitimg[0.82\textwidth]{Figuras/matriz_probabilidades_real.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        \postitimg[0.80\textwidth]{Figuras/redes_comparacion.png}
    \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
